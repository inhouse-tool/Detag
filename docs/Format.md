...
そのおかげでいずれの AI の出力も統一感のあるデザインに落ち着きますが,
この部分を見ないとどの AI との質疑だったのか見分けがつきません
	<table>
	<tr><td>AI<td>文言
...
[Notepad](https://apps.microsoft.com/detail/9msmlrh6lzf3?hl=ja-JP&gl=JP) のような「なんちゃって」では表示できません.
)</sup>
